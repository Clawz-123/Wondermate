        ...
        <div className="flex flex-col">
          ...
          <div className="flex h-[30rem] w-full gap-2 lg:gap-3 shadow-2xl">
            <div className="flex-[1.3]">
              {/* main big img div */}
              <img className="h-full w-full object-cover" src={travelPackage.img[0]} alt="" />
            </div>
            <div className="hidden md:block flex-[1]">
              <div className="h-full w-full grid grid-cols-2 grid-rows-2 gap-2 lg:gap-4">
                {/* 4 picture div */}
                {travelPackage.img.slice(1, 5).map((img, i) => (
          ...
          >
            {/* des div */}
            <div>
              <h1 className=" font-bold text-xl p-5">  {travelPackage.id} {travelPackage.name}</h1>
